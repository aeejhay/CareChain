    ...
    <div class="page-header">
        ...
        <div>
            <?php if ($user['wallet_address']): ?>
                <span class="wallet-display"><?= substr($user['wallet_address'], 0, 4) ?>...<?= substr($user['wallet_address'], -4) ?></span>
            <?php endif; ?>
        </div>
    </div>
            ...
            <form method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="hourly_rate" class="form-control" value="<?= number_format($profile['hourly_rate'] ?? 0, 2) ?>" step="0.50" min="12">
                    </div>
                </div>
                <div class="form-group">
                ...
                <?php foreach ($documents as $doc): ?>
                    <div class="credential-card" style="<?= $doc['status'] === 'pending' ? 'background: linear-gradient(135deg, var(--gray-700), var(--gray-500));' : '' ?>">
                        ...
                        <?php if ($doc['nft_mint_address']): ?>
                            <div class="nft-badge" onclick="viewOnExplorer('<?= $doc['nft_mint_address'] ?>')" style="cursor: pointer;">
